...
- **Chip Properties**: Use the board toolbar to map frontmatter fields into colored chip badges and optionally set one property as a card border color.
...
To configure chip properties, open any board and use the new toolbar button labeled "Configure chip properties" to select frontmatter fields and set border coloring.
